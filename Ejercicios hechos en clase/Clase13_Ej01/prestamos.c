...
*
*/
int Prestamos_buscarEmpty(Prestamos array[], int size, int* posicion)                    //cambiar Tipo
{
    int retorno=-1;
    int i;
...
int Prestamos_alta(Prestamos array[], int size, int* contadorID)
{
    ...
    {
        if(Prestamos_buscarEmpty(array,size,&posicion)==-1)
        {
        ...
        else
        {
            ...
            utn_getUnsignedInt("\nCodigo de libro: ","\nError",1,sizeof(int),1,1,1,&array[posicion].idLibro);
            utn_getUnsignedInt("\nCodigo de socio: ","\nError",1,sizeof(int),1,1,1,&array[posicion].idSocio);
            utn_getTexto("\nFecha del prestamo: ","\nError",1,TEXT_SIZE,1,array[posicion].fechaPrestamo);
            printf("\n Posicion: %d\n Codigo del prestamos: %d\n Codigo de libro: %d\n Codigo de socio: %d\n nFecha del prestamo: %s",
                   posicion, array[posicion].idUnico,array[posicion].idLibro,array[posicion].idSocio,array[posicion].fechaPrestamo);
            retorno=0;
        }
    }
    return retorno;
...
*/
/*
int Prestamos_baja(Prestamos array[], int sizeArray)                                      //cambiar Tipo
{
    int retorno=-1;
    int posicion;
    int id;
